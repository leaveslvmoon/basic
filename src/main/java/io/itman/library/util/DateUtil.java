...
public class DateUtil {
    ...
    /**
     * 格式化Date时间  采用默认格式的时间 yyyy-MM-dd HH:mm:ss
     * @param time Date类型时间
     * @return 格式化后的字符串
     */
    ...
    public static String parseDateToStr(Date time, String timeFromat, final Date defaultValue){
        try{
            return parseDateToStr(time,timeFromat);
        }catch (Exception e){
    ...
    public static Date parseStrToDate(String time) {
        return parseStrToDate(time,DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS);
    }
    ...
    /**
     * 格式化Object时间
     * @param time Object类型时间
     * @return 格式化后的String日期
     */
    public static String parseObjectToStr(Object time) {
        return parseObjectToStr(time,DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS);
    }

    /**
     * 格式化Object时间
     * @param time Object类型时间
     * @param timeFromat Object类型格式
     * @return 格式化后的String日期
     */
    public static String parseObjectToStr(Object time, String timeFromat) {
        if (time == null || time.equals("")) {
            return null;
        }
        String date=null;
...
//    }
    ...
    public static Date getDayBeginTime(Date date) {
        return formatHhMmSsOfDate(date);
    }
